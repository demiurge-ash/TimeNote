...
@section('content')
    ...
    <p class="lead">@lang('messages.about_author'): <a href="https://demiart.ru">Demiurge Ash</a> &copy; 2018</p>
    <p class="lead">GitHub: <a href="https://github.com/demiurge-ash/TimeNote">https://github.com/demiurge-ash/TimeNote</a></p>
    <p class="lead">@lang('messages.about_used'):
        <div class="col-lg-4 no-pad">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><a href="http://php.net/">PHP 7.1</a></li>
                <li class="list-group-item"><a href="https://laravel.com/">Laravel 5.6</a></li>
                <li class="list-group-item"><a href="https://getbootstrap.com/">Bootstrap 4.1</a></li>
